...
11. - [ ] [Task 11 — LangGraph Runner & Full Ingestion Integration](tasks/task-11-langgraph-runner-integration.md) *(2025-12-03: Blocked — repo lacks any LangGraph runner, retrieval pipeline, or concrete OpenAI/Voyage client implementations. Need foundational LangGraph orchestration + tool adapters before wiring `/v1/chat` to “real tools.”)*
