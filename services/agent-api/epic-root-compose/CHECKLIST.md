...
1. - [ ] [Task 01 — Deployment Discovery & Compose Plan](tasks/task-01-deployment-discovery.md)
2. - [ ] [Task 02 — Root Compose Implementation & Service Wiring](tasks/task-02-root-compose.md)
3. - [ ] [Task 03 — Environment Templates & Runtime Profiles](tasks/task-03-env-and-profiles.md)
