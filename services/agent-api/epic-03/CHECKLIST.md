...
16. - [x] [Task 16 — Production Valkey Client & Cache Wiring](tasks/task-16-valkey-integration.md) — Added ValkeyAsyncClient + env helpers, FastAPI DI, Testcontainers coverage, and cache rollout docs (2025-12-02).
