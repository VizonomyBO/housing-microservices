...
1. - [ ] [Task 01 — AgentState Schema Foundation](tasks/task-01-agent-state-schema.md)
...
6. - [ ] [Task 06 — Router Classification & Guardrail Policies](tasks/task-06-router-guardrails.md)
