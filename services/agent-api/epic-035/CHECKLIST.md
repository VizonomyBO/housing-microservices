...
4. - [x] [Task 04 — Reduced Scope Docker Compose Deployment](tasks/task-04-reduced-scope-deployment.md) — Dockerfile.reduced + docker-compose.reduced.yml + seed/runbook/smoke assets are in place for FastAPI + Postgres demos.
