...
- Real ingestion file: `services/agent-api/tests/data/reduced_e2e/doc_policy.pdf`.
...
- If LocalStack can’t run Step Functions/Lambda, document the workaround (e.g., docker-compose of lambdas with local triggers, or a reduced flow) and note gaps.
