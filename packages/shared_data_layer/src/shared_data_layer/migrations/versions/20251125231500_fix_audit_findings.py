...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "fk_graph_entities_owner_user_id_users", "graph_entities", type_="foreignkey"
    )

    # pillar_answers.owner_user_id -> users.id
    op.drop_constraint(
        "fk_pillar_answers_owner_user_id_users", "pillar_answers", type_="foreignkey"
    )
    ...
    op.add_column(
        "graph_communities", sa.Column("algo_version", sa.String(), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_pillar_answers_owner_user_id_users",
        "pillar_answers",
        "users",
        ["owner_user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_graph_entities_owner_user_id_users",
        "graph_entities",
        "users",
        ["owner_user_id"],
        ["id"],
