...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_user_id"],
            ["users.id"],
            name=op.f("fk_graph_entities_owner_user_id_users"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_graph_entities")),
    )
    op.create_index(
        op.f("ix_graph_entities_country_code"),
        "graph_entities",
        ["country_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_graph_entities_name"), "graph_entities", ["name"], unique=False
    )
    op.create_table(
        "ingestion_jobs",
        sa.Column("document_id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["graph_id"],
            ["workflow_graphs.id"],
            name=op.f("fk_workflow_versions_graph_id_workflow_graphs"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chunk_id"], ["chunks.id"], name=op.f("fk_chunk_metrics_chunk_id_chunks")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["graph_entities.id"],
            name=op.f("fk_graph_edges_source_id_graph_entities"),
        ),
        sa.ForeignKeyConstraint(
            ["target_id"],
            ["graph_entities.id"],
            name=op.f("fk_graph_edges_target_id_graph_entities"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chunk_id"],
            ["chunks.id"],
            name=op.f("fk_retrieval_run_items_chunk_id_chunks"),
        ),
        sa.ForeignKeyConstraint(
            ["run_id"],
            ["retrieval_runs.id"],
            name=op.f("fk_retrieval_run_items_run_id_retrieval_runs"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_workflow_edges_version_id_workflow_versions"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["version_id"],
            ["workflow_versions.id"],
            name=op.f("fk_workflow_nodes_version_id_workflow_versions"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chunk_id"], ["chunks.id"], name=op.f("fk_graph_evidence_chunk_id_chunks")
        ),
        sa.ForeignKeyConstraint(
            ["edge_id"],
            ["graph_edges.id"],
