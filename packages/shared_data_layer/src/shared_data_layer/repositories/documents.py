...
from shared_data_layer.db.models.documents import Document, ConversationDocument
...
class DocumentRepository(BaseRepository[Document]):
    ...
    async def create_or_get_document(self, owner_user_id: Optional[UUID], content_hash: str, **kwargs) -> Document:
        """
    ...
    async def detach_from_conversation(self, conversation_id: str, document_id: UUID) -> bool:
        """
