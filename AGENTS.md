...
- **Service map** (ports from env): agent-api 8000, ingestion-service 8085, auth-service 5001, user-service 5002, Postgres 5432; LocalStack/valkey/otel only in local profiles. Swagger service has been removed.
